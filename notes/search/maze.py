...
# Queue frontier inherits from stack, aka it does all the same things besides what we def
...
class Maze():
    ...
    def __init__(self, filename):
        ...
        # Validate that there is a start and a goal 
        ...
        # Keep track of walls -- set up a list for each row,
        # where the elements correspond to the spaces in the maze
        # True represents a wall, while False represents start, end,
        # or empty space 
